...
export const Vortex = (props: VortexProps) => {
    ...
    // Desktop: 120, Mobile: 50 — visually similar but ~4x cheaper than original
    const particleCount = isMobile ? 50 : (props.particleCount || 120);
    ...
    useEffect(() => {
        ...
        const renderGlow = () => {
            // Only apply expensive glow every 3rd frame
            if (frameCount % 3 !== 0 || isMobile) return;
            ctx.save();
        ...
        const draw = () => {
            ...
            // Throttle: skip every other frame on desktop to cut CPU ~40%
